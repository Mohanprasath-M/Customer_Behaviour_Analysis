-- ============================================================
-- CUSTOMER SHOPPING BEHAVIOR - SQL ANALYSIS QUERIES
...
-- Q2. Customers who used a discount but spent more than the
...
-- Q4. Compare average purchase amounts between Standard
...
-- Q5. Compare average spend and total revenue between
...
-- Q6. Top 5 products with the highest percentage of
...
-- Q9. Repeat buyers (more than 5 previous purchases) and
